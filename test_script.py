...
# print(run_keyword_extraction_api(in_string, language='eng', max_num_keywords=10))
# print()
...
in_string = '버스정류장은 버정과 뻐정 사이에 있어요. 정류장은 저쪽에 있고요. 버스는 지금 오고 있습니다. 버저를 눌러주세요. 버는 여기에 있어요, 고터와 고속터미널은 이쪽에 있습니다. 고속터는 저기에 있고 골터는 여기 있어요.'
# in_string = '올리브 영, 올영, 올립영, 올리브 영 먹는 올리브영은 올리브, 아이, 농촌이 아니다.'

t1=time.time()

print('<한국어 키 명사 추출 10개>')
print(run_keyword_extraction_api(in_string, language='kor', max_num_keywords=10))
print()
